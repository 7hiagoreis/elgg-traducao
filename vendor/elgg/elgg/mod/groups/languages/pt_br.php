...
return array(
	...
	/**
	 * Menu items and titles / Itens de menu e títulos
	 */
	...
	'relationship:invited' => '%2$s foi convidado(a) para entrar em %1$s',
	...
	'groups:invite:friends:help' => 'Busque por um Membro pelo Nome ou Nome de Usuário e selecione-o na lista',
	...
	'groups:search:none' => "Nenhum Grupo correspondente encontrado",
	...
	'groups:closedgroup:membersonly' => "A Participação neste Grupo é Fechada e o Conteúdo é Acessível Apenas por Membros.",
...
Clique abaixo para ver o perfil dele(a):
%s
...
%s",
	...
	/**
	 * Action messages / Mensagens de Ação
	 */
	...
	// Notification settings / Configurações da Notificação
	...
	'groups:usersettings:notifications:description' => 'Para receber notificações quando novos conteúdos forem adicionados a um grupo do qual você participa, encontre o grupo abaixo e selecione o(s) método(s) de notificação desejado(s).',
